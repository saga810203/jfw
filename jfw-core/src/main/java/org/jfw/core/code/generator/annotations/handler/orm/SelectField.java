...
public class SelectField {
    ...
    public static SelectField  build(DE f) {
        SelectField sf = new SelectField();
        sf.fieldClass = f.getFieldClass();
        sf.beanFieldName = null;
        sf.dbFieldName =null;
        sf.dbFieldAlias =null;
        sf.nullable =f.isNullable();
        sf.getClass =f.getReadClass();
        return sf;
    }
