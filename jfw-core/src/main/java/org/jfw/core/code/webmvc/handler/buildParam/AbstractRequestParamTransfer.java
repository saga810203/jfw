...
public abstract class AbstractRequestParamTransfer implements RequestParamTransfer {
    ...
    @Override
    public void transfer(StringBuilder s, int p,Type t, ControllerMethodCodeGenerator c,RequestParam annotation) {
        this.sb=s;
        this.paramIndex=p;
        this.type=t;
        this.cmcg=c;
    ...
    public void transferBeanProperty(StringBuilder s, int p, Type t,
            ControllerMethodCodeGenerator c, RequestParamTransfer.FieldRequestParam frp) {
        this.sb=s;
        this.paramIndex=p;
        this.type=t;
        this.cmcg=c;
