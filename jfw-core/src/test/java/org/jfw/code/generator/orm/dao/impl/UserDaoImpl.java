...
public class UserDaoImpl implements org.jfw.code.generator.orm.dao.UserDao {
	...
	@Override
	public int insertUser(java.sql.Connection con, org.jfw.code.generator.orm.po.LoginUser param1)
			throws java.sql.SQLException {
		String sql = "INSERT INTO LOGINUSER (MODIFY_TIME,CREATE_TIME,USERID,MAN,MAN2,AGE,HEIGHT,NAME,ALIAS_NAME,WEIGHT,LOGIN_TIME) VALUES (to_char('YYYYMMDDHH24MISS',SYSDATE),to_char('YYYYMMDDHH24MISS',SYSDATE),?,?,?,?,?,?,?,?,?)";
		java.sql.PreparedStatement ps = con.prepareStatement(sql);
		try {
			int paramIndex = 1;
			...
			ps.setLong(paramIndex++, param1.getLoginTime());
	...
	@Override
	public java.util.List<org.jfw.code.generator.orm.po.LoginUser> getAllUserByName(java.sql.Connection con,
			java.lang.String param1, java.lang.String param2, boolean param3, java.lang.Boolean param4)
			throws java.sql.SQLException {
		String sql = "SELECT USERID,MAN,MAN2,AGE,HEIGHT,NAME,ALIAS_NAME,WEIGHT,CREATE_TIME,MODIFY_TIME,LOGIN_TIME FROM LOGINUSER WHERE MAN=? AND NAME=? AND ALIAS_NAME=? AND MAN2=?";
		java.sql.PreparedStatement ps = con.prepareStatement(sql);
		try {
			int paramIndex = 1;
			...
			java.sql.ResultSet rs = ps.executeQuery();
			try {
				java.util.List<org.jfw.code.generator.orm.po.LoginUser> result = new java.util.LinkedList<org.jfw.code.generator.orm.po.LoginUser>();
				while (rs.next()) {
					org.jfw.code.generator.orm.po.LoginUser obj = new org.jfw.code.generator.orm.po.LoginUser();
					obj.setUserid(rs.getString(1));
					obj.setMan("1".equals(rs.getString(2)));
					java.lang.Boolean tmp_1 = "1".equals(rs.getString(3));
					if (rs.wasNull()) {
					...
					obj.setCreateTime(rs.getString(9));
					obj.setModifyTime(rs.getString(10));
					obj.setLoginTime(rs.getLong(11));
					result.add(obj);
				}
				return result;
			} finally {
	...
	@Override
	public java.util.List<org.jfw.code.generator.orm.po.LoginUser> getAllUserByName3(java.sql.Connection con,
			java.lang.String param1, java.lang.String param2, boolean param3, java.lang.Boolean param4)
			throws java.sql.SQLException {
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT USERID,MAN,MAN2,AGE,HEIGHT,NAME,ALIAS_NAME,WEIGHT,CREATE_TIME,MODIFY_TIME,LOGIN_TIME FROM LOGINUSER");
	...
	@Override
	public int updateUser(java.sql.Connection con, org.jfw.code.generator.orm.po.LoginUser param1)
			throws java.sql.SQLException {
		String sql = "UPDATE LOGINUSER SET MODIFY_TIME=to_char('YYYYMMDDHH24MISS',SYSDATE),LOGIN_TIME=?,HEIGHT=?,AGE=?,MAN=?,MAN2=?,NAME=?,ALIAS_NAME=?,WEIGHT=?,CREATE_TIME=? WHERE USERID=?";
		java.sql.PreparedStatement ps = con.prepareStatement(sql);
		try {
			int paramIndex = 1;
			ps.setLong(paramIndex++, param1.getLoginTime());
			...
			java.lang.String tmp_5 = param1.getCreateTime();
			if (null != tmp_5) {
				ps.setString(paramIndex++, tmp_5);
			} else {
				ps.setNull(paramIndex++, 12);
			}
			ps.setString(paramIndex++, param1.getUserid());
	...
	@Override
	public java.util.List<org.jfw.code.generator.orm.po.LoginUser> getAllUserByName2(java.sql.Connection con,
	...
	@Override
	public java.util.List<org.jfw.code.generator.orm.vo.UserVO> getAllUserVO(java.sql.Connection con)
			throws java.sql.SQLException {
		String sql = "SELECT a.USERID,a.MAN,a.MAN2,a.AGE,a.HEIGHT,a.NAME,a.ALIAS_NAME,a.WEIGHT,a.CREATE_TIME,a.MODIFY_TIME,a.LOGIN_TIME,case where AGE >=18 WHEN '0' ELSE '1' END child FROM LOGINUSER a";
		java.sql.PreparedStatement ps = con.prepareStatement(sql);
		try {
			java.sql.ResultSet rs = ps.executeQuery();
			try {
				java.util.List<org.jfw.code.generator.orm.vo.UserVO> result = new java.util.LinkedList<org.jfw.code.generator.orm.vo.UserVO>();
				while (rs.next()) {
					org.jfw.code.generator.orm.vo.UserVO obj = new org.jfw.code.generator.orm.vo.UserVO();
					obj.setUserid(rs.getString(1));
					obj.setMan("1".equals(rs.getString(2)));
					java.lang.Boolean tmp_1 = "1".equals(rs.getString(3));
					if (rs.wasNull()) {
					...
					obj.setModifyTime(rs.getString(10));
					obj.setLoginTime(rs.getLong(11));
					obj.setChild("1".equals(rs.getString(12)));
					result.add(obj);
				}
				return result;
			} finally {
	...
	@Override
	public java.util.List<org.jfw.code.generator.orm.po.LoginUser> getAllUser(java.sql.Connection con)
			throws java.sql.SQLException {
		String sql = "SELECT USERID,MAN,MAN2,AGE,HEIGHT,NAME,ALIAS_NAME,WEIGHT,CREATE_TIME,MODIFY_TIME,LOGIN_TIME FROM LOGINUSER";
		java.sql.PreparedStatement ps = con.prepareStatement(sql);
		try {
			java.sql.ResultSet rs = ps.executeQuery();
			try {
